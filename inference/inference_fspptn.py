...
from basicsr.archs.fspptn_arch import FSPPTN


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument('--input', type=str, default=r'datasets/Set5/LRbicx4', help='input test image folder')
    parser.add_argument('--output', type=str, default='results/FSPPTN/Set5', help='output folder')
    parser.add_argument(
        '--task',
        type=str,
        default='real_sr',
    ...
    parser.add_argument(
        '--model_path',
        type=str,
        default=r'experiments/pretrained_models/FSPPTN_DIV2K_X4.pth')
    ...
    for idx, path in enumerate(sorted(glob.glob(os.path.join(args.input, '*')))):
        ...
        cv2.imwrite(os.path.join(args.output, f'{imgname}_sftn.png'), output)
